...
function GameGearRepairPart2() {
  ...
  return (
    <div>
      <Paragraph>
        In{" "}
        <Link href={"/blog/retro-gaming/game-gear-repair-part-1"}>part 1</Link>,
        I started my repair of a broken Game Gear by disassembling it and
        cleaning corrosion off of its PCBs. I mentioned how even after the
        cleaning, the Game Gear would only stay powered on for about a second,
        which was probably because of old capacitors (a very common problem with
        Game Gears). Now it was time to try replacing the capacitors.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        <ExternalLink link="https://www.khanacademy.org/science/physics/circuits-topic/circuits-with-capacitors/v/capacitors-series">
          Khan Academy
        </ExternalLink>{" "}
      ...
      <Paragraph>
        ...
        <ExternalLink link="https://console5.com/wiki/Game_Gear">
          here
        </ExternalLink>
        ), I saw that two of the pins should read 5V and one pin should read
        35V. Sure enough, that’s what I saw when testing each pin with the
        multimeter.
      </Paragraph>
      ...
      <EmbeddedYouTubeVideo url="https://www.youtube.com/embed/v6fKlSTHOZI" />
      ...
      <Paragraph>
        <Link href={"/blog/retro-gaming/game-gear-repair-part-3"}>
          Continued in part 3.
        </Link>
      </Paragraph>
    </div>
